        ...
        <b-container>
            ...
            <div class="event-page__multimedia">
                <b-container>
                    ...
                    <b-row class="d-flex">
                        <b-col lg="6">
                            <b-img src="../assets/images/site_logo.jpg" fluid-grow alt="site_logo"></b-img>
                        </b-col>
                        <b-col lg="6">
                ...
                <b-row>
                    <b-col lg="6">
                        <div class="event-page__banner-text">
                            <small>Meet your every objective with Radisson Meetings</small>
                            <h3 class="event-page__banner-title">Discover Radisson Meetings</h3>
                ...
                <b-row>
                    <b-col cols="12" class="event-page__footer-list">
                        <b-col lg="4" class="event-page__footer-item">
                            <div class="event-page__footer-title">Contact Radisson Hotels</div>
