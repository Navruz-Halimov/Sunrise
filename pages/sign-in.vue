    ...
    <b-container class="sign__content">
      <b-row>
        <div class="sign__title">
          <h2>Sign-in</h2>
          <p>Please sign in by completing the information below. All fields are required.</p>
        </div>
        <b-form class="sign__form">
          <b-row>
            <b-col class="sign__input" cols="12" sm="12" md="6" lg="4" offset-lg="2">
              <b-form-group
        ...
        <b-col class="pl-0 mt-5" lg="10" offset-lg="2">
          ...
          <p>If you can’t remember your membership number, username, or password, please contact customer service:</p>
          <span>Within the US & Canada: <a href="#">Call (800) 544-9288.</a></span>
          <span>Outside the US & Canada: <a href="#">View contact information.</a></span>
        </b-col>
      </b-row>
    </b-container>
  </div>
