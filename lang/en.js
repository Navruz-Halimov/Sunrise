export default {
    ...
    toast: {
        ...
        sMessage: 'Information updated successfully.',
        error: 'Mistake',
        eMessage: 'An error occurred while loading the image',
        loginError: 'Mistake',
        loginErrorMessage: 'The phone number or password was entered incorrectly.',
        loginSuccessMessage: 'You have successfully entered your profile.',
        signupErrorMessage: 'An error occurred while creating the profile.',
        updateProfile: 'Your profile has been successfully updated.',
        updateProfileError: 'An error occurred while entering information',
        lawyerpost: 'Your request has been accepted. Wait for the administration to approve.',
